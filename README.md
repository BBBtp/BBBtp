...
Привет ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif) Меня зовут Богдан  
==============================================================================================================================  

### iOS Developer  

Я специализируюсь на разработке мобильных приложений для iOS и использовании передовых технологий для решения сложных задач. Активно изучаю Android и веб-технологии, что позволяет рассматривать разработку в широком контексте.  

[![trophy](https://github-profile-trophy.vercel.app/?username=BBBtp)](https://github.com/ryo-ma/github-profile-trophy)
### Навыки  
...
### Реализованные проекты
 - [Кинозадачки](https://github.com/BBBtp/MovieQuiz1):
   Приложение для ответов на вопросы о рейтингах 
   фильмов с подсчетом баллов.

 - [Приложение просмотра фото](https://github.com/BBBtp/imageFeed): 
    Личная галерея с просмотром фотокарточек и 
    личным кабинетом.

 - [Трекер привычек](https://github.com/BBBtp/Tracker):
    Помогает следить за привычками и анализировать 
    успехи. 

- [NFT Marketplace](https://github.com/BBBtp/iOS-FakeNFT-Team3): 
  Платформа для покупки NFT. 

- Рецепты автоматического приготовления кофе: 
   Сервис для создания и отслеживания рецептов 
   кофе. 
### Социальные сети  

<p align="left">
<a href="https://github.com/BBBtp" target="_blank" rel="noreferrer">
